...
{{--              <input type="text" name="email" id="email" value="{{ old('email') }}" placeholder="{{ __('voyager::generic.email') }}" class="form-control" required>--}}
              <input type="text" name="email" id="email" value="admin@admin.com" placeholder="{{ __('voyager::generic.email') }}" class="form-control" required>
            </div>
          </div>
          ...
          <div class="form-group form-group-default" id="passwordGroup">
            ...
            <div class="controls">
              <input type="password" name="password" placeholder="{{ __('voyager::generic.password') }}" class="form-control" required value="password">
            </div>
          </div>
