          ...
          @foreach($dataType->readRows as $row)
            ...
            <div class="panel-body" style="padding-top:0;">
              ...
              @elseif($row->type == 'relationship')
                <!-- [CUSTOM] DISPLAY ALL SALE ITEMS-->
                {{-- @todo REPLACE THIS WITH TABLE --}}
                @if($row->details->model === "App\SaleItem")
                  <ul>
                  @php
                    $sales = \App\Sale::find(request()->segment(3));
                    foreach($sales->saleItems as $sale) {
                      echo "<li>". "<b>name:</b> ". $sale->product->name . " " . "<b>Quantity:</b> ". $sale->quantity_sold . " ". "<b>Price: </b>" . $sale->price . "</li>";
                    }
                  @endphp
                  </ul>
                  @else
